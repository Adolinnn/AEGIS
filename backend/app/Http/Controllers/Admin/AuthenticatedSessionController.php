    ...
    public function dashboard(Request $request): Response
    {
        return Inertia::render('Admin/Dashboard', [
            ...
            'stats' => [
                ...
                'total_vulnerabilities' => Finding::count(),
                'unresolved_vulnerabilities' => Finding::unresolved()->count(),
            ],
            ...
            'recentVulnerabilities' => Finding::with('target:id,domain_url,user_id')->latest('detected_at')->limit(15)->get(),
