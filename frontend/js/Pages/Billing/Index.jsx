                        ...
                        <p className="text-sm text-gray-400">
                            ...
                            {currentTier !== 'free' && (
                                <>
                                    ...
                                    {auth.trial_active ? (
                                        <>
                                            Currently on a <span className="text-gray-200">30-day trial</span> of the <span className="text-gray-200 capitalize">{currentTier}</span> plan ({auth.trial_days_remaining} {auth.trial_days_remaining === 1 ? 'day' : 'days'} left).{' '}
                                        </>
                                    ) : (
                                        <>
                                            Currently on <span className="text-gray-200 capitalize">{currentTier}</span>.{' '}
                                        </>
                                    )}
                                    <button
                                        onClick={cancel}
